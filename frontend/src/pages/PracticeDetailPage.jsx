...
const PracticeDetailPage = () => {
  ...
  if (!problem) return <div className="text-center py-12">Practice problem not found</div>
  ...
  return (
    <div className="space-y-6">
      <Link to="/practice" className="inline-flex items-center text-leetcode-yellow hover:underline">
