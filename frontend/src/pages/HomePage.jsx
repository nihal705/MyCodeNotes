...
const HomePage = () => {
  ...
  // Refetch when the tab becomes visible / window regains focus
  useEffect(() => {
    const handleVisibilityChange = () => {
      if (document.visibilityState === "visible") fetchProblems();
    };
  ...
  const stats = [
    ...
    {
      value: contentStats.concepts,
      label: "Concepts Covered",
      icon: FiLayers,
      color: "text-purple-600",
    },
    {
      value: contentStats.practice,
      label: "Practice Problems",
      icon: FiZap,
      color: "text-blue-600",
    },
    {
      value: contentStats.notes,
    ...
    <div className="container-custom mx-auto">
      ...
      >
        ...
        <motion.section
          ...
          className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-cream-50 via-white to-beige-50 dark:from-[#1F232C] dark:via-[#262B36] dark:to-[#1F232C] p-10 md:p-16 shadow-sm border border-beige-200 dark:border-[#2E3440] text-center"
        >
          ...
          <div className="relative z-10 text-center">
            <h1 className="text-5xl md:text-6xl lg:text-6xl font-bold text-gray-900 dark:text-[#E6EDF3] leading-tight max-w-4xl mx-auto">
              Learn DSA, Programming &amp;
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FFA116] to-yellow-500">
                {" "}
                Practice Smarter
              </span>
            </h1>
            <p className="text-gray-600 dark:text-[#C2CAD4] text-xl md:text-1xl mt-4 max-w-2xl mx-auto leading-relaxed">
              Everything here is something I've personally solved, practiced, or
              studied — organized so it's actually useful to work through.
            </p>
            <div className="flex flex-wrap justify-center gap-4 mt-6">
              <Link
                to="/problems"
                className="inline-flex items-center gap-2 bg-leetcode-yellow text-gray-900 px-8 py-3.5 rounded-full font-semibold shadow-lg hover:shadow-xl hover:bg-yellow-500 transition-all duration-300 text-lg"
              >
              ...
              <a
                href="#stats"
                className="inline-flex items-center gap-2 bg-transparent text-gray-700 dark:text-gray-200 px-8 py-3.5 rounded-full font-medium border-2 border-gray-300 dark:border-[#30363D] hover:border-leetcode-yellow hover:text-leetcode-yellow dark:hover:border-leetcode-yellow dark:hover:text-leetcode-yellow transition-all duration-300 text-lg"
              >
                Explore Content
              </a>
            </div>
        ...
        >
          {learningPaths.map((path) => (
            ...
            >
              <div
                className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${path.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}
              >
