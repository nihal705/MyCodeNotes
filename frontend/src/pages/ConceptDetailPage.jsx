...
const ConceptDetailPage = () => {
  ...
  if (!concept) return <div className="text-center py-12">Concept not found</div>

  return (
    <div className="space-y-6">
      <Link to="/concepts" className="inline-flex items-center text-leetcode-yellow hover:underline">
